...
// import IngredientsModalComponent from "../ItemModalComponent/IngredientsModalComponent";
...
const AllProductCard = ({ product }) => {
	...
	return parseInt(product.price, 10) && othersPrice_status ? (
		<>
			...
			>
				...
				>
					...
					<div>
						...
						{/* {
              product.description ? (
                <div className="descriptionText">{product.description}</div>) : null
            } */}
						<div className="productRateText">
							<span>SurePlus Price</span>
							<br />
							{productRate}
						</div>
					...
					<div className="stocksLeft">
						{parseInt(product.stock, 10) > 0 ? (
							...
							<div align="center">
								<p color="red" className="soldOutText">
									Sold Out
								</p>
							</div>
						)}
